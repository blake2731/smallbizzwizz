      ...
      <main style={styles.page}>
        <div style={styles.shell}>
          <header style={styles.header}>
            ...
            <span style={styles.paidBadge}>PAID REVENUE LEAK MAP</span>
          </header>

          <section style={styles.hero}>
            <div>
              <div style={styles.eyebrow}>FULL DIAGNOSTIC</div>
          ...
          <section style={styles.panel}>
            ...
            <div style={styles.metrics}>
              <Metric label="Page response" value={`${(result.responseMs / 1000).toFixed(1)} sec`} />
              ...
              <Metric label="Scanned" value={new Date(result.scannedAt).toLocaleDateString('en-US')} />
            </div>
            <p style={styles.disclaimer}>
              This diagnostic evaluates observable website conversion signals. It does not estimate lost dollars without the business&apos;s actual traffic, call volume, close rate, and average job value.
            </p>
          </section>
